...
export const servicePages: ServicePage[] = [
  {
    ...
    additionalIndustryLinks: [
      ...
      {
        href: '/industries/financial-operations/',
        label: 'financial operations and ledger systems',
      },
    ],
  },
  {
    ...
    additionalIndustryLinks: [
      {
        ...
        label: 'guesthouse booking-request flows and owner portals',
      },
    ],
  },
  {
...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    summary:
      'A local tourism directory built around verified business listings, category browsing, direct contact actions, and a structured business-submission workflow.',
    projectOverview: [
      'The Sen Monorom Local Guide was built to make it easier for visitors to discover local cafés, restaurants, tours, guesthouses, rentals, and other businesses using clearer, owner-confirmed information.',
      'The project combines a public directory, category browsing, direct contact actions, verification labels, empty states for unverified categories, and a business-submission path for local owners.',
    ],
    industry: 'Local Tourism / Business Directory',
    companySize: 'Independent local guide project',
    projectType: 'Verified local business directory and tourism guide',
    goal: [
      'Organize local businesses by category',
      'Show verified counts and listing status',
      'Make direct contact actions easy',
      'Distinguish confirmed listings from missing or unverified data',
      'Support owner-submitted business details',
      'Keep category empty states honest',
      'Help visitors browse practical local options',
      'Create a maintainable structure for future listings',
    ],
    ...
    problemOneLiner:
      'Visitors had to piece together local business information from social posts, maps, and directory pages with inconsistent freshness and trust signals.',
    outcomeOneLiner:
      'The guide provides structured category browsing, visible verification states, direct contact actions, and an honest submission path for local owners.',
    homepageBuilt: [
    ...
    clientType:
      'Local tourism operators, visitors, and small businesses that need clearer discovery, trust signals, and direct contact pathways',
    serviceLine: 'Custom Business Systems',
    proof: ['Local directory platform', 'Verified listing structure', 'Search-friendly local guide'],
    businessProblem:
      'Visitors often rely on scattered social posts, outdated directory pages, or incomplete business information when looking for places in Sen Monorom. Local businesses also need a clearer way to submit accurate details and make direct contact options easy to find.',
    oldWorkflow: [
      'Local information was spread across multiple channels.',
      'Business hours and contact details could become outdated.',
      'Visitors had difficulty distinguishing confirmed listings from unverified information.',
      'Local businesses lacked one structured submission path.',
      'Category pages needed consistent listing states.',
      'Direct Maps, phone, WhatsApp, Facebook, and website actions were fragmented.',
      'Empty categories needed honest messaging instead of fake or placeholder listings.',
    ],
    scopeDelivered: [
      'Homepage with local guide positioning and category navigation',
      'Café, restaurant, tour, guesthouse, and motorbike-rental category views',
      'Verified listing counts and owner-confirmed badges',
      'Direct contact actions and Google Maps links',
      'Business submission page and verification-status messaging',
      'Honest category empty states',
      'Responsive layout and static deployment',
      'Structured content organization',
    ],
    keyFeatures: [
      'Category filters and verified listing counts',
      'Listing cards with business photos and logos',
      'Owner-confirmed status, hours, location, and last-verified date',
      'Maps, Call, WhatsApp, Facebook, and Website actions',
      'Empty states for unverified categories',
      'Business submission guidance and direct submission channels',
      'Trust messaging and update-date visibility',
    ],
    architectureSummary:
      'The guide was implemented as a static, content-driven Astro site with reusable listing cards, category views, trust labels, direct-contact actions, and honest empty-state behavior.',
    technicalShape: [
      'Astro static site and static routing',
      'Reusable category pages and listing cards',
      'Structured content data and verification-state presentation',
      'Optimized images and responsive layouts',
      'Direct external contact links',
      'Business submission flow',
      'Category-specific empty states',
    ],
    constraints: [
      'Local information can become outdated quickly.',
      'Trust labels must not overstate verification.',
      'Categories may have zero listings.',
      'Visitors need direct action paths and a useful mobile experience.',
      'Listing content needs consistent, maintainable structure.',
      'External contact details must remain easy to update.',
    ],
    keyDecisions: [
      'Separated verified listings from unconfirmed information.',
      'Used explicit owner-confirmed labels and last-verified dates.',
      'Showed zero-listing categories honestly instead of inventing content.',
      'Kept direct contact with businesses as the primary action.',
      'Created a structured submission path for local owners.',
      'Used category counts to set expectations.',
    ],
    outcomes: [
      'Clearer local business discovery',
      'More consistent listing presentation',
      'Stronger trust through visible verification states',
      'Easier direct contact with businesses',
      'A clearer submission path for local owners',
      'A maintainable base for adding more verified listings',
    ],
    demonstrates: [
      'Local directory and structured content design',
      'Trust-oriented UX and empty-state design',
      'Tourism discovery and small-business listing workflows',
      'Conversion-focused direct-contact design',
      'Static-site performance and maintainable content architecture',
    ],
    ...
    screenshots: [
      {
        image: '/assets/images/sen-monorom-local-guide.webp',
        alt: 'Sen Monorom Local Guide waterfall hero and local discovery actions',
        label: 'Local tourism discovery homepage',
      },
      {
        image: '/images/industries/tourism-hospitality/sen-monorom-guide-full-page.webp',
        alt: 'Full Sen Monorom Local Guide homepage and verified listing structure',
        label: 'Full guide structure and verified listings',
      },
      {
        image: '/images/industries/tourism-hospitality/sen-monorom-guide-cafes.webp',
        alt: 'Sen Monorom Local Guide verified café listing',
        label: 'Verified café listing',
      },
      {
        image: '/images/industries/tourism-hospitality/sen-monorom-guide-restaurants.webp',
        alt: 'Sen Monorom restaurant listings and direct contact actions',
        label: 'Restaurant category and direct-contact actions',
      },
      {
        image: '/images/industries/tourism-hospitality/sen-monorom-guide-tours.webp',
        alt: 'Sen Monorom tour listing with location and contact details',
        label: 'Tour listing and location details',
      },
      {
        image: '/images/industries/tourism-hospitality/sen-monorom-guide-guesthouses.webp',
        alt: 'Sen Monorom Local Guide guesthouse category empty state',
        label: 'Honest empty state for guesthouses',
      },
      {
        image: '/images/industries/tourism-hospitality/sen-monorom-guide-motorbike-rentals.webp',
        alt: 'Sen Monorom Local Guide motorbike rental category empty state',
        label: 'Honest empty state for motorbike rentals',
      },
      {
        image: '/images/industries/tourism-hospitality/sen-monorom-guide-submit-business.webp',
        alt: 'Sen Monorom Local Guide business submission guidance',
        label: 'Business submission workflow',
      },
    ],
    ...
    relatedIndustryLink: {
      href: '/industries/tourism-hospitality/',
      label: 'Explore tourism and hospitality systems',
    },
  },
  {
  ...
  {
    slug: 'tessera-multi-tenant-ledger-platform',
    title: 'Tessera Multi-Tenant Ledger Platform',
    summary:
    ...
    projectOverview: [
      'Tessera was designed as a multi-tenant ledger operations platform for systems that need stronger guarantees than ordinary CRUD applications.',
      'The workspace separates accounts, balances, transfer posting, and transaction history while enforcing organization scope, role-aware access, deterministic financial rules, and idempotent write behavior.',
    ],
    industry: 'Financial Operations / Fintech Infrastructure',
    companySize: 'Multi-tenant SaaS product concept',
    projectType: 'Ledger operations and account management platform',
    goal: [
      'Isolate financial data by organization',
      'Model and classify ledger accounts explicitly',
      'Calculate balances from posted journal activity',
      'Post transfers transactionally with idempotency protection',
      'Preserve traceable transaction history',
      'Expose role-aware authenticated workspace access',
      'Provide deterministic empty states and operational visibility',
    ],
    problemOneLiner:
    ...
    clientType:
      'Fintech products, marketplaces, SaaS platforms, and internal finance systems that need organization-scoped accounts, balance integrity, and traceable transfers',
    serviceLine: 'Custom Business Systems',
    proof: ['Multi-tenant ledger model', 'Transactional and idempotent posting', 'Role-aware financial workspace'],
    businessProblem:
      'Financial records require stricter domain rules than ordinary business data. Account ownership, tenant isolation, balance integrity, transaction traceability, and duplicate-posting protection need to be explicit in both the data model and application workflow.',
    oldWorkflow: [
    ...
    constraints: [
      ...
      'Transfer posting must not leave partial journal activity.',
      'Retries must not create duplicate journal writes.',
      'Balances must remain derivable and consistent.',
      'Authorization must be enforced server-side.',
      'Transaction history must remain traceable.',
      'Empty workspaces must behave predictably.',
      'Financial domain rules must remain explicit.',
    ],
    keyDecisions: [
    ...
    image: '/images/industries/financial-operations/tessera-overview.webp',
    alt: 'Tessera organization-scoped ledger operations workspace overview',
    screenshots: [
      {
        image: '/images/industries/financial-operations/tessera-sign-in.webp',
        alt: 'Tessera secure workspace sign-in page',
        label: 'Secure workspace sign-in',
      },
      {
        image: '/images/industries/financial-operations/tessera-overview.webp',
        alt: 'Tessera organization-scoped ledger overview',
        label: 'Organization-scoped ledger overview',
      },
      {
        image: '/images/industries/financial-operations/tessera-accounts.webp',
        alt: 'Tessera chart of accounts and classification summaries',
        label: 'Chart of accounts and account classification',
      },
      {
        image: '/images/industries/financial-operations/tessera-balances.webp',
        alt: 'Tessera derived ledger balance summaries',
        label: 'Derived balance summaries',
      },
      {
        image: '/images/industries/financial-operations/tessera-transfer.webp',
        alt: 'Tessera transactional transfer workflow',
        label: 'Transactional transfer workflow',
      },
      {
        image: '/images/industries/financial-operations/tessera-transactions.webp',
        alt: 'Tessera traceable ledger activity view',
        label: 'Traceable ledger activity',
      },
    ],
    referenceLabel: 'Portfolio application',
    referenceText:
      'The captured interface demonstrates the workflow structure and deterministic empty states; seeded data screenshots would provide stronger proof of account, balance, transfer, and transaction behavior.',
    relatedIndustryLink: {
      href: '/industries/financial-operations/',
      label: 'Explore financial operations and ledger systems',
    },
  },
  {
    slug: 'mondulkiri-guesthouse-booking-system',
    title: 'Mondulkiri Guesthouse Booking System',
    summary:
      'A guesthouse booking-request and owner operations platform that helps guests submit stay details while giving owners clearer control over requests, room availability, offline blocks, and public listing settings.',
    projectOverview: [
      'The project was designed for a small guesthouse that needed a clearer booking-request workflow without the complexity of a full hotel management platform.',
      'Guests can review rooms, rates, capacity, and contact options before submitting stay details. Owners can sign in to review requests, record direct bookings, block rooms for offline use, manage room information, and control whether the public listing is published.',
    ],
    industry: 'Guesthouse / Tourism Operations',
    companySize: 'Small guesthouse operator',
    projectType: 'Booking-request system and owner portal',
    goal: [
      'Give guests a simple public booking-request path',
      'Show room rates, capacity, and basic details clearly',
      'Keep requests separate from confirmed bookings',
      'Help owners review pending, confirmed, and rejected requests',
      'Support direct bookings from calls or walk-ins',
      'Allow offline room blocking',
      'Centralize guesthouse profile and room configuration',
      'Control publication of the public listing',
    ],
    problemOneLiner:
      'Booking requests, room availability, offline blocks, and guest follow-up needed one structured workflow instead of calls, messages, and manually maintained notes.',
    outcomeOneLiner:
      'The resulting portfolio application pairs a structured public booking-request path with an owner portal for request review, availability, room blocking, configuration, and publishing controls.',
    clientType:
      'Small accommodations and guesthouses managing room requests, availability, and direct guest communication',
    serviceLine: 'Client Portals & Estimator Tools',
    proof: ['Booking-request workflow', 'Authenticated owner portal', 'Availability and room-block controls'],
    businessProblem:
      'Small guesthouses often manage bookings through calls, Telegram, WhatsApp, Facebook messages, and handwritten or spreadsheet notes. That makes availability harder to track, room blocks easier to miss, and guest follow-up less consistent.',
    oldWorkflow: [
      'Booking requests arrived through multiple channels.',
      'Room availability was checked manually.',
      'Offline bookings and maintenance blocks were easy to miss.',
      'Room details and rates lacked one central place.',
      'Public listing updates required manual handling.',
      'Owners needed a clearer distinction between requests and confirmed bookings.',
    ],
    scopeDelivered: [
      'Public guesthouse page with room listing cards, rates, and capacity',
      'Structured booking-request form',
      'Owner authentication and tenant-aware portal structure',
      'Booking-request dashboard with status filtering',
      'Direct booking entry',
      'Availability review and offline room blocking',
      'Guesthouse profile settings and room management',
      'Publish and unpublish controls',
      'Responsive public and owner application layouts',
    ],
    keyFeatures: [
      'Public booking-request page and room selection',
      'Guest contact details and optional message',
      'Stay date and guest-count selection',
      'Booking status management',
      'Manual direct-booking support',
      'Availability date-range view',
      'Room-block workflow',
      'Room rates and capacities',
      'Guesthouse contact settings',
    ...
    constraints: [
      'The system needed to remain simple enough for a small guesthouse team.',
      'Requests and confirmed bookings needed a clear distinction.',
      'Offline bookings and owner-use blocks needed first-class support.',
      'The public and owner experiences needed to work well on mobile.',
      'The first phase needed to work without online payment.',
      'Direct contact through Telegram, WhatsApp, phone, and Facebook needed to remain available.',
      'Room data and public content needed to stay manageable by the owner.',
    ],
    keyDecisions: [
    ...
    outcomes: [
      'Clearer booking-request path for guests',
      'More structured owner review workflow',
      'Better visibility into room availability and blocks',
      'Centralized room and guesthouse settings',
      'Cleaner distinction between pending requests and confirmed stays',
      'A practical first phase without unnecessary hotel-system complexity',
    ],
    demonstrates: [
      'Booking workflow and owner portal design',
      'Public and private application flows',
      'Structured intake and availability management',
      'Role-based access',
      'Small-business operational software',
      'Custom tourism systems',
      'Maintainable first-phase scope',
    ],
    image: '/images/industries/tourism-hospitality/mondulkiri-guesthouse-public-booking.webp',
    alt: 'Mondulkiri guesthouse public room selection and booking-request page',
    screenshots: [
      {
        image: '/images/industries/tourism-hospitality/mondulkiri-guesthouse-public-booking.webp',
        alt: 'Mondulkiri guesthouse public room selection and booking-request page',
        label: 'Public room selection and booking-request flow',
      },
      {
        image: '/images/industries/tourism-hospitality/mondulkiri-guesthouse-owner-login.webp',
        alt: 'Mondulkiri guesthouse owner portal login',
        label: 'Secure owner portal access',
      },
      {
        image: '/images/industries/tourism-hospitality/mondulkiri-guesthouse-bookings.webp',
        alt: 'Mondulkiri guesthouse booking request dashboard',
        label: 'Booking request review and status management',
      },
      {
        image: '/images/industries/tourism-hospitality/mondulkiri-guesthouse-availability.webp',
        alt: 'Mondulkiri guesthouse room availability and blocking view',
        label: 'Room availability and offline blocking',
      },
      {
        image: '/images/industries/tourism-hospitality/mondulkiri-guesthouse-settings.webp',
        alt: 'Mondulkiri guesthouse profile, publishing, and room settings',
        label: 'Guesthouse profile, publishing, and room configuration',
      },
    ],
    referenceLabel: 'Portfolio application',
    referenceText: 'Booking-request and owner operations system shown through the portfolio interface',
    relatedIndustryLink: {
      href: '/industries/tourism-hospitality/',
      label: 'Explore tourism and hospitality booking systems',
    },
  },
  {
